...
<head>
    ...
    <style>
        ...
        /* Update container styles for better glass effect */
        .login-container {
        ...
        /* Keep other styles but add animations to alerts */
        .alert {
        ...
        <div class="login-banner">
            ...
            <div class="banner-content">
                ...
                <div class="banner-header">
                    <h2>Welcome Back!</h2>
                    <p>Sign in to access your account and explore our latest collection of premium phones and accessories.</p>
                </div>
